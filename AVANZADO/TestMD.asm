...
#LW_INC recien expulsado -> VIA 0: 160,164,168,172 ; VIA 1: 224,228,232,236
...
lw r1,0(r0)			# Read miss sobre via 0
lw r2,64(r0)		# Read miss sobre via 1
lw_inc r1,128(r0)	# lw_inc miss que no invalida.
lw r1,0(r0)			# Read hit sobre via 0
lw r1,128(r0)		# Read miss que reemplaza sobre via 0
lw r1,0(r0)			# Read miss que reemplaza sobre via 1
sw r1,68(r0)		# Write miss que reemplaza sobre via 0

sw r1,144(r0) 		# Write hit sobre Set "01" VIA 0